...
- Read `agents/event-recap.md` for your full instructions
...
Instruction to agent (pass as prompt):
- Read `agents/qa-knowledge-base.md` for your full instructions
...
Instruction to agent (pass as prompt):
- Read `agents/course-outline-enhancer.md` for your full instructions
...
Instruction to agent (pass as prompt):
- Read `agents/content-idea-curator.md` for your full instructions
...
**Notes:** Extracted by content-idea-curator agent via /process-livestream.
```
...
- Append a session row with: date, stream title, "livestream transcript", count of ideas, comma-separated list of IDs, "Extracted by content-idea-curator agent via /process-livestream."
...
After displaying the summary, call `agents/admin.md` with:
- `action: move`
