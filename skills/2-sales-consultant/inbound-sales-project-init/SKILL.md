...
```bash
npx skills add https://github.com/peter-tu-zynkr/zynkr-skill-builder --skill inbound-sales-project-init
```
...
`./references/context-doc-template.md`
