...
│   ├── 3.03 admin-meeting-prep              (admin-meeting-prep/)         ✓ A scheduled, auto-running admin-meeting-prep assistan… +agents
...
│   ├── 3.08 admin-governance               (admin-governance/)          ✓ Weekly hygiene ritual for Zynkr's local↔cloud k…
...
│   └── 6.13              (/)         ✓ Self-improving AI agent runtime by Nous Researc…
├── 7-people-talent/
