...
| 5.0 (Product) | `5.0 product/` | `1UNKjQdy3wACcRP7pbd-zwU7hK6Exh7D5` | `[5.0] 產品部門` | Cloud canonical (LOB-taxonomy hub, since 2026-06-11). **Scan recursively**: subfolder `[5.1] Lucid Workflow Engineering conventions` (`1R4DfLi07Z5SaYBB4Q8-8QuKMjh7o0JYm`) holds the engineering convention docs (.md files; native-Docs conversion pending). Their read-only local mirror is `6.0 tech/engineering-conventions/` — flag mirror drift when the cloud copies change |
