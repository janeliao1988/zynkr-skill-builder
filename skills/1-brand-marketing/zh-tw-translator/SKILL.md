...
description: "Translate English (or any source language) into natural, conversational Traditional Chinese using Taiwanese expressions and tone. Removes the 'translation smell' that comes from word-for-word renderings."
category: brand-marketing
project: zh-tw-translator
platform: claude
status: Done
author: Peter Tu
sheetId: "1.09"
...
```bash
npx skills add https://github.com/peter-tu-zynkr/zynkr-skill-builder --skill zh-tw-translator
```
...
- Default to zh-TW even if the user didn't specify — that's this skill's whole purpose
