...
author: Jane Liao
description: >-
  A scheduled, auto-running admin-meeting-prep assistant: every day at 9 AM it
  scans meetings within the next 7 days and sends action reminders; every day at
  3 PM it sends a full briefing for the next day's meetings. Notifications are
  sent to yourself via Google Chat. No manual trigger needed; does not handle
...
synergy:
  - '3.03'
  - '3.04'
installCommand: curl -sL zynkr.ai/s/3.03.md -o ~/.claude/skills/admin-meeting-prep.md
updatedAt: '2026-06-11'
firstSeen: '2026-06-09'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 3-operations/admin-meeting-prep/SKILL.md
---
