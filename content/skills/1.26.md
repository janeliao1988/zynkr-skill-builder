...
description: >-
  ...
  slide-visual-selector's job, and rendering the .pptx is the pptx skill's job.
input: >-
...
synergy:
  - '1.26'
installCommand: curl -sL zynkr.ai/s/1.26.md -o ~/.claude/skills/slide-storyline-designer.md
