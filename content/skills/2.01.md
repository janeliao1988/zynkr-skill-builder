...
author: Peter Tu
description: >-
  9-step sales client sourcing pipeline — turn a workshop/event satisfaction
  survey into an enriched outbound funnel with company website, background,
  tailored 陌生開發 strategy, Hot Lead flag, and Well-Known firm flag.
input: >-
...
synergy:
  - '2.01'
installCommand: curl -sL zynkr.ai/s/2.01.md -o ~/.claude/skills/sales-client-sourcing.md
updatedAt: '2026-06-11'
firstSeen: '2026-06-09'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 2-sales-consultant/sales-client-sourcing/SKILL.md
---
