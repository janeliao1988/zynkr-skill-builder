...
author: Peter Tu
description: >-
  Surfaces underrepresented skills by comparing the candidate's CV with the job
  requirements from phase 1, then guides the candidate to articulate strong,
  job-aligned stories using the SCQA framework. Prompt reference — runs in the
...
sourceFile: 7-people-talent/cv-customizer/agents/cv-story-extractor.md
---
