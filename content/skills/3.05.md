...
description: >-
  ...
  'what changed in cloud this week', '/admin-governance', or when the user
  pastes nothing but asks to reconcile local/cloud state. Should fire eagerly
  when the user references the weekly hygiene ritual from the Zynkr
...
synergy:
  - '3.05'
installCommand: curl -sL zynkr.ai/s/3.05.md -o ~/.claude/skills/admin-governance.md
updatedAt: '2026-06-09'
firstSeen: '2026-05-25'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 3-operations/admin-governance/SKILL.md
---
