...
description: >-
  ...
  content-cta agent to analyze your article and suggest the best CTAs."
  <commentary> Since the user has a completed article and wants CTA suggestions,
  use the Task tool to launch the content-cta agent. </commentary> </example>

  <example> Context: The user wants a CTA that matches the article's goal. user:
  "幫我根據這篇文章選合適的CTA。" assistant: "I'll use the content-cta agent to read the
  article and generate three matched CTA options." <commentary> Since the user
  wants matched CTA suggestions for their article, launch the content-cta agent.
  </commentary> </example>
input: Final article
process: >-
...
sourceFile: 1-brand-marketing/zynkr-content-writer/.claude/agents/content-cta.md
---
