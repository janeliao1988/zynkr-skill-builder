...
description: >-
  ...
  taxonomy, check for duplicates in the GitHub Project pipeline, and propose new
  skills as issues for review.
...
output: >-
  ...
  added to the skills pipeline GitHub Project with Pipeline Status=proposed,
  Keep=?. On approval the...
ipoProvenance:
  input: frontmatter
  output: frontmatter
legacyIpoId: '6.03'
...
synergy:
  ...
  - '6.06'
  - '6.07'
installCommand: curl -sL zynkr.ai/s/6.03.md -o ~/.claude/skills/skill-sourcer.md
