...
author: Peter Tu
description: >-
  7-phase business card pipeline — OCR extraction, schema normalization, Google
  Sheet CRM logging, company research, and personalized follow-up email
  drafting.
input: Business card image(s) — single or batch
process: >-
  OCR via Claude Vision → schema normalization → user review → Google Sheet
  append → company research → follow-up email draft → Gmail save
...
synergy:
  - '2.19'
  - '2.20'
installCommand: curl -sL zynkr.ai/s/2.19.md -o ~/.claude/skills/biz-card.md
updatedAt: '2026-06-01'
firstSeen: '2026-05-24'
sourceRepo: 'https://github.com/peter-tu-zynkr/zynkr-skill-builder'
sourceFile: 2-sales-consultant/biz-card/SKILL.md
---
