...
process: >-
  Redesign each step into structured, automation-ready workflows with task
  breakdowns, system layer mapping, and tool suggestions.
output: >-
  Builder-ready tables with sub-tasks, flow type, MVP stack, and a summary for
...
sourceFile: 3-operations/operations-transformation/agents/operations-process-redesign.md
---
