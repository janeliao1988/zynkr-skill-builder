...
description: >-
  ...
  Context: The user has a completed draft from content-draft and wants editorial
  review.

  user: "初稿完成了，幫我校稿。"

  assistant: "Let me bring in the content-editor agent to review your draft and
  provide improvement suggestions."

  <commentary>

  Since the user has a completed draft and wants editorial review, use the Task
  tool to launch the content-editor agent.
  ...
  assistant: "I'll use the content-editor agent to review your article and
  suggest edits."
...
sourceFile: 1-brand-marketing/zynkr-content-writer/.claude/agents/content-editor.md
---
