...
description: >-
  ...
  FAQ section, outputting a handoff summary compatible with article-drafter.
...
process: >-
  ...
  information → human review → output an article-drafter-compatible handoff
  summary
output: >-
  Article outline + FAQ + handoff summary of target keywords, handed off to
  article-drafter (1.06) for writing
ipoProvenance:
  input: frontmatter
  process: frontmatter
  output: frontmatter
